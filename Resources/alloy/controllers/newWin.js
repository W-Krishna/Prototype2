function Controller() {
    ...
    $.__views.newWin.add($.__views.__alloyId8);
    ...
    seeWebView ? $.__views.__alloyId10.addEventListener("click", seeWebView) : __defers["$.__views.__alloyId10!click!seeWebView"] = true;
    ...
    openUserData ? $.__views.__alloyId12.addEventListener("click", openUserData) : __defers["$.__views.__alloyId12!click!openUserData"] = true;
    exports.destroy = function() {};
    _.extend($, $.__views);
    $.newWin.open();
    __defers["$.__views.__alloyId10!click!seeWebView"] && $.__views.__alloyId10.addEventListener("click", seeWebView);
    __defers["$.__views.__alloyId11!click!goBack"] && $.__views.__alloyId11.addEventListener("click", goBack);
    __defers["$.__views.__alloyId12!click!openUserData"] && $.__views.__alloyId12.addEventListener("click", openUserData);
    _.extend($, exports);
}
